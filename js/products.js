    ...
    for (let i = 0; i < currentCategoriesArray.length; i++) {
        ...
        if (((minCount == undefined) || (minCount != undefined && parseInt(category.cost) >= minCount)) &&
            ...
            <div class="row">
                ...
                <img src="` + category.imgSrc + `" alt="` + category.description + `" class="img-thumbnail"></a>
                </div>
                <div class="col">
                    ...
                    <div class="row">
                      ...
                      <div class="col">
                         <input type="submit" class="addToCart" value="Agregar al carrito"><br><br>
                         <input type="submit" class="buy" value="Comprar"><br><br>
                       </div>              
                    </div>
                </div>
            </div>
        ...
        if (cadena.indexOf(formulario) !== -1) {
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="col">
                      <input type="submit" class="addToCart" value="Agregar al carrito">
                        </div>
                </div>
            </div>
        </a>
